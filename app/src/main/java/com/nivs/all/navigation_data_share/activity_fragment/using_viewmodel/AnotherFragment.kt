...
import com.nivs.all.databinding.FragmentAnotherBinding
...
class AnotherFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        framentViewModel.data.observe(viewLifecycleOwner) {
            binding.textviewAnother.text = it.toString()
        }


        val data = arguments
        if(data?.containsKey("Hi") == true){
            binding.textviewAnother.text = data?.getString("Hi")
        }
